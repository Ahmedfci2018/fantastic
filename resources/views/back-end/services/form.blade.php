...
<div class="row">
    ...
    <div class="col-md-3" width="90px" height="50px">
        <div class="">
            <img alt="Architectural design Architicts Design" src="{{isset($row) ? asset('uploads/service_images/'. $row->image) : asset('uploads/service_images/default.png')}}" width="100px" height="60px" class="img-thumbnail img-preview">
        </div>
    </div>
